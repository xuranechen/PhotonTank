            ...
            case StatusCode.Connect:
                if (this.State == ClientState.ConnectingToNameServer)
                {
                    if (PhotonNetwork.logLevel >= PhotonLogLevel.Full)
                    {
                        ...
                        GameMgr.Instance.LobbyMgr.landUI.TextShow("Connected to NameServer.");
                    }
                ...
                if (this.State == ClientState.ConnectingToGameserver)
                {
                    if (PhotonNetwork.logLevel >= PhotonLogLevel.Full)
                    {
                        ...
                        GameMgr.Instance.LobbyMgr.landUI.TextShow("Connected to gameserver.");
                    }
                ...
                if (this.State == ClientState.ConnectingToMasterserver)
                {
                    if (PhotonNetwork.logLevel >= PhotonLogLevel.Full)
                    {
                        ...
                        GameMgr.Instance.LobbyMgr.landUI.TextShow("Connected to masterserver.");
                    }
